...
`,b=({children:t,isDisabled:e,forId:l,isActive:a=!1,dataTestId:r,style:n,isRequired:i,hasError:d=!1})=>{const p=r??"label-field";return s.jsxs(f,{"data-testid":p,disabled:e,hasError:d,htmlFor:l,isActive:a,style:n,children:[t,i?s.jsx(c,{children:" *"}):null]})};export{b as L};
