...
`,b=n.button`
  ...
  `}
`,$={[o.Error]:h,[o.Info]:u,[o.Success]:f,[o.Warning]:C,[o.Default]:null},l=({children:t,dataTestId:s,style:d,type:r=o.Default,onClose:a})=>{const g=!!a,i=$[r];return e.jsxs(w,{"data-testid":s??"message",style:d,type:r,children:[i?e.jsx(M,{type:r,children:e.jsx(i,{"data-testid":"message-icon",height:"16px",width:"16px"})}):null,e.jsx(j,{children:t}),g?e.jsx(b,{onClick:a,children:e.jsx(p,{height:"16px",width:"16px"})}):null]})};l.Title=({children:t})=>e.jsx(c,{color:"content.heading",element:"h2",fontStyles:"body2Bold",children:t});l.Description=({children:t})=>e.jsx(c,{color:"content.body",fontStyles:"body3",children:t});l.Action=({children:t,dataTestId:s})=>e.jsx(m,{"data-testid":s??"message-action",children:t});export{l as M,o as O};
