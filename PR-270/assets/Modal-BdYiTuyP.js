import{j as a}from"./jsx-runtime-CKrituN3.js";import{h as f,a as x}from"./Backdrop-70bNWptn.js";import"./index-DjLjG34w.js";import{P as u}from"./Portal-U_0UEmB3.js";import{r as p}from"./index-CBqU2yxZ.js";import{u as m}from"./useClickOutside-D7JrBqcS.js";import{n as s}from"./emotion-styled.browser.esm-B1le5_Hy.js";import{B as y}from"./index-DMRWov4L.js";import{I as $}from"./Icon-DOElHRRq.js";import{T as c}from"./Typography-BuALMDSW.js";import{S as g}from"./Spinner-CchqEybk.js";import"./index-BtM5VmRH.js";import{M as b}from"./z-index-Ds5QkyqS.js";const h=s.div`
  ${({theme:t})=>`
    padding: ${t.spacing.xs};
    overflow-y: auto;

    @media only screen and (max-width: ${t.breakpoints.s}) {
      flex: 1;
      }
    `}
...
`,M=({dataTestId:t,handleClose:e,hasBackgroundColor:o=!1,hasBorder:n=!1,title:r,subTitle:i,style:d})=>a.jsxs(v,{"data-testid":t??"modal-header",hasBackgroundColor:o,hasBorder:n,style:d,children:[a.jsxs(y,{style:{justifyContent:"space-between",flexDirection:"row"},children:[a.jsx(c,{color:"content.dark",element:"h4",fontStyles:"h4",children:r}),a.jsx($,{code:"close",dataTestId:"close-icon",onClick:e,size:"large"})]}),i?a.jsx(c,{color:"content.default",element:"h5",fontStyles:"body1",children:i}):null]}),S=s.div`
  ${({theme:t})=>`
      ...
      right: 0;
      bottom: 0;
      background-color: ${f(t.palette.surface.light,.8)};
      display: flex;
      align-items: center;
