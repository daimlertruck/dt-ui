...
to {
  ...
  animation: ${Nt} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,zt=({toast:t})=>{let{icon:e,type:r,iconTheme:s}=t;return e!==void 0?typeof e=="string"?d.createElement(Zt,null,e):e:r==="blank"?null:d.createElement(Ht,null,d.createElement(It,{...s}),r!=="loading"&&d.createElement(Dt,null,r==="error"?d.createElement(Tt,{...s}):d.createElement(At,{...s})))},Bt=t=>`
