import{n as e}from"./emotion-styled.browser.esm-yeljtSWm.js";const d=e.div`
  display: block;
  height: auto;
  width: 100%;
  position: relative;
`,p=e.input`
  ${({theme:t,hasError:o,disabled:l})=>`
    ...
    color: ${l?t.palette.text.disabled:t.palette.text.body};
    min-width: 198px;
...
`,s=e.div`
  padding-left: 15px;
`;export{i as I,d as T,p as a,s as b};
