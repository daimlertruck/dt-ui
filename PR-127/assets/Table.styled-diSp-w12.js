import{n as t}from"./emotion-styled.browser.esm-yeljtSWm.js";const i=t.table`
  ${({isFixed:a})=>`
...
`,p=t.th`
  ...
  `}
`,b=t.td`
  ${({theme:a,columnWidth:o,textAlign:d,isVisible:n})=>`
    display: flex;
  ...
  `}
`;export{p as C,l as R,i as T,e as a,r as b,b as c};
