import{j as r}from"./jsx-runtime-CKrituN3.js";import"./index-BpxOyJIn.js";import"./index-BtM5VmRH.js";import{b as u}from"./z-index-Bx-k-k_v.js";import{r as g}from"./index-CBqU2yxZ.js";import{n}from"./emotion-styled.browser.esm-DhD7UCCJ.js";const f=n.thead`
...
`,H=({children:t,dataTestId:a,style:o,onClick:e})=>{const l=!!e;return r.jsx(j,{...e&&{onClick:e},"data-testid":a??"table-row",selectableRow:l,style:o,children:t})},R=n.td`
  ${({theme:t,columnWidth:a,textAlign:o,showBoxShadow:e,sticky:l,stickyEnd:s,stickyColumnIndex:d,stickyEndColumnIndex:i})=>`
    ...
    ${(l||s)&&`
      ...
      `}
  `}
`,B=g.forwardRef(({children:t,columnWidth:a,style:o,dataTestId:e,textAlign:l="left",showBoxShadow:s=!1,sticky:d=!1,stickyEnd:i=!1,stickyColumnIndex:$=0,stickyEndColumnIndex:x=0},c)=>r.jsx(R,{columnWidth:a,"data-testid":e??"table-data-cell",ref:c,showBoxShadow:s,sticky:d,stickyColumnIndex:$,stickyEnd:i,stickyEndColumnIndex:x,style:o,textAlign:l,children:t})),C=n.table`
  ${({isFixed:t})=>`
