...
`,j=a.input`
  ...
  `}
`,l=({children:t,dataTestId:e})=>o.jsx(w,{"data-testid":e??"pagination-wrapper",children:t});l.Content=({totalPages:t,onClick:e})=>o.jsxs(C,{fontStyles:"pXSmall",children:["of"," ",o.jsx(h,{"data-testid":"pagination-last-page",onClick:e,title:"Go to last page",children:t})]});l.NextItem=({onClick:t,disabled:e})=>o.jsx(f,{"data-testid":"pagination-next-item",disabled:e,onClick:t,title:"Go to next page",children:o.jsx(b,{})});l.PreviousItem=({onClick:t,disabled:e})=>o.jsx(f,{"data-testid":"pagination-previous-item",disabled:e,onClick:t,title:"Go to previous page",children:o.jsx($,{})});const R=({totalPages:t,onHandleKeyDown:e,value:i,onChange:d})=>{const[r,u]=n.useState(1),[g,c]=n.useState(!1),x=n.useMemo(()=>y(s=>s(),500),[]);n.useEffect(()=>{i!==void 0&&u(i)},[i]),n.useEffect(()=>{r&&r<=t&&x(()=>{d(r)})},[x,r,d,t]);const m=s=>{const p=Number(s.target.value);u(p),p>t||p===0?c(!0):c(!1)};return o.jsx(j,{"data-testid":"pagination-input",hasError:g,onChange:m,onKeyDown:e,value:r})};export{l as P,R as a};
