import{j as l}from"./jsx-runtime-vNq4Oc-g.js";import{B as w}from"./index-H1EXaXUo.js";import{C as M}from"./Close-fCiS4iy8.js";import{u as $,A as S,M as O}from"./MultiSelectProvider-vrdgqO57.js";import{n as x,u as C}from"./emotion-styled.browser.esm-Scfyu_ZY.js";import{r as d}from"./index-4g5l5LRQ.js";import{T as k}from"./Tag-okJQ4zFc.js";import{O as D,a as R,D as E}from"./DropdownMenu-ToIU4zHv.js";import{T as j}from"./Typography-hG7SbwPH.js";import"./index-LonLnBAn.js";import"./index-jmm5gWkb.js";import"./Icon.styled-_wbYwLP-.js";import{u as A}from"./useClickOutside-5i9YsATO.js";const I=x.li`
  ${({theme:e,disabled:t})=>`
...
`,B=({dataTestId:e,option:t,children:n,isDisabled:o,onClick:i,onClose:p})=>{const{state:r,dispatch:c,name:g}=$(),u={text:t.text??t.value,value:t.value},v=()=>{i&&i(t==null?void 0:t.value,g),c({type:S.ADD,payload:t})},y=()=>{c({type:S.REMOVE,payload:u}),p&&p(t)},h=!!r.find(s=>s.value===t.value),m=o||h,b=e??`multi-select-option-${t.value}`;return l.jsxs(w,{style:{flexDirection:"row",justifyContent:"space-between"},children:[l.jsx(I,{"data-testid":b,disabled:m,onClick:v,role:"option",children:n},t.value),t.isRemovable&&m?l.jsx(T,{onClick:y,children:l.jsx(M,{height:12,width:12})}):null]})},X=x.div`
  ${({theme:e,hasError:t=!1,isDisabled:n})=>`
    ...
    ${n&&`
      ...
      `}
  `}
`,P=({children:e,label:t,placeholder:n,dataTestId:o="multi-select-item",isDisabled:i=!1,hasError:p=!1,onClose:r})=>{const{state:c,dispatch:g,isOpen:u,setIsOpen:v}=$(),y=C(),h=s=>{s.preventDefault(),v(a=>!a)},m=(s,a)=>{s.stopPropagation(),g({type:S.REMOVE,payload:a}),r&&r(a)},b=d.useMemo(()=>d.Children.map(e,s=>s&&d.cloneElement(s,{...s.props,onClose:r})),[e,r]);return l.jsxs(l.Fragment,{children:[l.jsxs(X,{"data-testid":o,hasError:p,isDisabled:i,onClick:h,children:[l.jsxs("div",{style:{overflow:"hidden"},children:[l.jsx(j,{color:"content.body",fontStyles:"pXXSmall",children:t}),c.length?l.jsx(w,{style:{flexDirection:"row",gap:"8px"},children:c.map(s=>d.createElement(k,{dataTestId:"multi-select-tag",...s.isRemovable&&{onClose:a=>m(a,s)},isClickable:s.isRemovable,key:`tag--${s.value}`},s.text))}):l.jsx(j,{color:"content.disabled",fontStyles:"pSmall",style:{textOverflow:"ellipsis",overflow:"hidden"},children:n??"Select an option"})]}),u?l.jsx(R,{}):l.jsx(D,{color:i?y.palette.content.disabled:"currentColor"})]}),u?l.jsx(E,{dataTestId:o,children:b}):null]})},V=({children:e})=>{const{setIsOpen:t}=$(),n=d.useRef(null);return A({ref:n,handler:()=>t(!1)}),l.jsx("div",{ref:n,children:e})},F=x.div`
  ${({theme:e})=>`
