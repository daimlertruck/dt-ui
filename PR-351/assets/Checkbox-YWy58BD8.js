import{j as r}from"./jsx-runtime-BTCK_S7S.js";import{I as u}from"./Icon-CLENxiAA.js";import{r as f}from"./index-CBqU2yxZ.js";import{n as a,u as h}from"./emotion-styled.browser.esm-BiJbFOXH.js";const b=(t,o,e)=>o?`
        border: none;
...
`,w=a.span`
  ...
  `}
`,S=f.forwardRef(({dataTestId:t="checkbox-id",onChange:o,children:e,isChecked:l=!1,isDisabled:n=!1,style:p,...c},i)=>{const s=h(),d=x=>{n||o==null||o(x)};return r.jsxs(g,{"data-testid":t,isChecked:l,isDisabled:n,style:p,children:[r.jsxs(y,{children:[r.jsx($,{checked:l,disabled:n,onChange:d,ref:i,type:"checkbox",...c}),l?r.jsx(u,{code:"check",color:s.palette.content.contrast}):null]}),e?r.jsx(w,{isChecked:l,isDisabled:n,children:e}):null]})});export{S as C};
