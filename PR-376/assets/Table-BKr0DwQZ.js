import{j as p}from"./jsx-runtime-DMAvRu52.js";import{r as l}from"./index-Dl6G-zuu.js";import"./index-CZJtwzpj.js";import"./index-DCrStp1_.js";import{b as L,c as I}from"./z-index-Ds5QkyqS.js";import{n as m}from"./emotion-styled.browser.esm-DpDeK1WQ.js";const _={columnsLength:0,setColumnsLength:()=>null,fixedColumnCount:0,fixedEndColumnCount:0,fixedColumns:[],setFixedColumns:()=>null,fixedEndColumns:[],setFixedEndColumns:()=>null,showBoxShadow:[],setShowBoxShadow:()=>null,isColumnsFixed:!1},B=l.createContext(_),v=({children:e,fixedColumnCount:o,fixedEndColumnCount:s,isColumnsFixed:r})=>{const n=l.useRef([]),t=l.useRef([]),d=l.useRef(0),a=l.useRef([]),x={get columnsLength(){return d.current},setColumnsLength:i=>{d.current=i},fixedColumnCount:o,fixedEndColumnCount:s,isColumnsFixed:r,get fixedColumns(){return n.current},setFixedColumns:i=>{n.current=i},get fixedEndColumns(){return t.current},setFixedEndColumns:i=>{t.current=i},get showBoxShadow(){return a.current},setShowBoxShadow:i=>{a.current=i}};return p.jsx(B.Provider,{value:x,children:e})},g=()=>{const e=l.useContext(B);if(!e)throw new Error("Table compound components cannot be rendered outside the Table component");return e},H=m.thead`
  ${({theme:e,hasFixedHeader:o})=>`
    ...
    ${o&&`
      ...
      `}
`}
`,N=({style:e,dataTestId:o,children:s,hasFixedHeader:r=!1})=>{const{setColumnsLength:n}=g();return l.Children.map(s,t=>{var d;l.isValidElement(t)&&n(((d=t.props.children)==null?void 0:d.length)??0)}),p.jsx(H,{"data-testid":o??"table-head",hasFixedHeader:r,style:e,children:s})},O=m.th`
