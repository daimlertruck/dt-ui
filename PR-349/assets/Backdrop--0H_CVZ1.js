import{j as s}from"./jsx-runtime-BTCK_S7S.js";import{r as n}from"./index-CBqU2yxZ.js";import"./index-alWhQwoC.js";import"./index-D_w70K-N.js";import{B as p}from"./z-index-Ds5QkyqS.js";import{n as c}from"./emotion-styled.browser.esm-DQrX-Ye0.js";const d=(t,r=1)=>{const[a,e,o]=(t.match(/\w\w/g)||[]).map(i=>parseInt(i,16));return`rgba(${a},${e},${o},${r})`},m={dark:.85,light:.2},l=c.div`
  ${({theme:t,type:r})=>`
      width: 100vw;
      height: 100vh;
      position: fixed;
