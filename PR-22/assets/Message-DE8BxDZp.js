...
`,$=r.button`
  ...
  `}
`,v={[o.Error]:h,[o.Info]:x,[o.Success]:f,[o.Warning]:C,[o.Default]:null},a=({children:t,dataTestId:s,style:d,type:n=o.Default,onClose:l})=>{const g=!!l,i=v[n];return e.jsxs(w,{"data-testid":s??"message",style:d,type:n,children:[i?e.jsx(m,{type:n,children:e.jsx(i,{"data-testid":"message-icon",height:"16px",width:"16px"})}):null,e.jsx(j,{children:t}),g?e.jsx($,{onClick:l,children:e.jsx(u,{height:"16px",width:"16px"})}):null]})};a.Title=({children:t})=>e.jsx(c,{color:"content.dark",element:"h2",fontStyles:"body2Bold",children:t});a.Description=({children:t})=>e.jsx(c,{color:"content.default",fontStyles:"body3",children:t});a.Action=({children:t,dataTestId:s})=>e.jsx(M,{"data-testid":s??"message-action",children:t});export{a as M,o as O};
