import{s as e}from"./emotion-styled.browser.esm-DuL_gwYN.js";const l=e.div`
  ${({theme:o,hasBackground:t,isDisabled:r,hasBorderBottom:s})=>`
    position: relative;
    width: 100%;
    background-color: ${t?o.palette.surface.light:"transparent"};
    border-bottom: ${s?`1px solid ${o.palette.border.default}`:"none"};
