import{j as p}from"./jsx-runtime-CKrituN3.js";import{r as s}from"./index-CBqU2yxZ.js";import{n as d}from"./emotion-styled.browser.esm-DhD7UCCJ.js";const b=d.button`
  ...
  ${({theme:o,active:t,disabled:r,variant:e})=>`
    ...
    ${r&&`
     ...
     `};
  `}
`,$=({activeTab:o,children:t,dataTestId:r,isDisabled:e,index:n,variant:l="boxed",handleChange:a})=>p.jsx(b,{active:o===n,"data-testid":r||`tab-item-${n}`,disabled:e,onClick:()=>a(n),role:"tab",tabIndex:o===n?0:-1,variant:l,children:t}),c=d.div`
  display: flex;
  flex-direction: row;
