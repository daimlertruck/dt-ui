import{n as l}from"./emotion-styled.browser.esm-B1le5_Hy.js";const i=l.div`
...
`,p=l.div`
  ...
  `}
`,u=l.div`
  ${({theme:t,isFloatingLabel:o,variant:e,backgroundColor:r})=>`
    display:flex;
    flex-direction: row;
    align-items: center;
    min-width: 198px;
    ...
    gap: ${t.spacing["4xs"]};
    background-color: ${r==="contrast"?t.palette.surface.contrast:t.palette.surface.light};
  ...
  `}
`;export{u as I,p as R,i as T,d as a,n as b,s as c,c as d};
