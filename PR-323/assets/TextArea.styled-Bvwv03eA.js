import{n as a}from"./emotion-styled.browser.esm-B1le5_Hy.js";const o=(e,t)=>({default:t.palette.surface.default,contrast:t.palette.surface.contrast,light:t.palette.surface.light})[e]||t.palette.surface.default,p=a.div`
  ${({theme:e})=>`
    display: flex;
...
`,f=a.textarea`
  ...
  `}
`;export{p as T,f as a,n as b,s as c};
