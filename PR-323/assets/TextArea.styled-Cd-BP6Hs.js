import{n as o}from"./emotion-styled.browser.esm-B1le5_Hy.js";const a=(e,r)=>({default:r.palette.surface.default,contrast:r.palette.surface.contrast,light:r.palette.surface.light})[e]||r.palette.surface.default,p=o.div`
  ${({theme:e})=>`
    display: flex;
...
`,f=o.div`
  ...
  `}
`,n=o.textarea`
  ${({theme:e,variant:r,resize:l,hasError:t=!1,backgroundFill:d})=>`
    ${e.fontStyles.pSmall}

    background-color: ${a(d,e)};
  ...
  `}
`;export{p as T,n as a,f as b,i as c};
