...
`,m=n.button`
  ...
  `}
`,y={[o.Error]:x,[o.Info]:u,[o.Success]:f,[o.Warning]:h,[o.Default]:null},a=({children:t,dataTestId:e,style:d,type:r=o.Default,onClose:l})=>{const g=!!l,i=y[r];return s.jsxs(w,{"data-testid":e??"message",style:d,type:r,children:[i?s.jsx($,{type:r,children:s.jsx(i,{"data-testid":"message-icon",height:"16px",width:"16px"})}):null,s.jsx(b,{children:t}),g?s.jsx(m,{onClick:l,children:s.jsx(p,{height:"16px",width:"16px"})}):null]})};a.Title=({children:t})=>s.jsx(c,{color:"content.heading",element:"h2",fontStyles:"body2Bold",children:t});a.Description=({children:t})=>s.jsx(c,{color:"content.body",fontStyles:"body3",children:t});a.Action=({children:t,dataTestId:e})=>s.jsx(j,{"data-testid":e??"message-action",children:t});export{a as M,o as O};
