import{j as o}from"./jsx-runtime-vNq4Oc-g.js";import{T as m}from"./Tooltip-Kt2lY6UW.js";import{r as s}from"./index-4g5l5LRQ.js";import{A as x}from"./ArrowRight-R00SQyn0.js";import{n as l}from"./emotion-styled.browser.esm-QTPHyGVR.js";import"./index-P2lXlfzc.js";import"./index-jmm5gWkb.js";import{d as w}from"./debounce-hfrKQpz_.js";import{u as g}from"./emotion-element-c39617d8.browser.esm-4Kx8mvQ5.js";const v=e=>o.jsx("svg",{fill:"currentColor",height:"24",viewBox:"0 0 24 24",width:"24",xmlns:"http://www.w3.org/2000/svg",...e,children:o.jsx("path",{d:"M6 10C4.9 10 4 10.9 4 12C4 13.1 4.9 14 6 14C7.1 14 8 13.1 8 12C8 10.9 7.1 10 6 10ZM18 10C16.9 10 16 10.9 16 12C16 13.1 16.9 14 18 14C19.1 14 20 13.1 20 12C20 10.9 19.1 10 18 10ZM12 10C10.9 10 10 10.9 10 12C10 13.1 10.9 14 12 14C13.1 14 14 13.1 14 12C14 10.9 13.1 10 12 10Z"})}),y=e=>{const[r,t]=s.useState(!1);return s.useEffect(()=>{const n=window.matchMedia(e);n.matches!==r&&t(n.matches);const i=()=>t(n.matches);return n.addEventListener("change",i),()=>n.removeEventListener("change",i)},[e,r]),r};function R(e,r=500){s.useEffect(()=>{const t=w(e,r);return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[e,r])}const $=l.nav`
  ${({theme:e})=>`
    ${e.fontStyles.body2}
