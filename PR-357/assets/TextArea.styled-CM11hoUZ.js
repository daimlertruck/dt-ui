import{n as a}from"./emotion-styled.browser.esm-DpDeK1WQ.js";const o=(e,t)=>({default:t.palette.surface.default,contrast:t.palette.surface.contrast,light:t.palette.surface.light})[e]||t.palette.surface.default,s=a.div`
  ${({theme:e})=>`
    display: flex;
...
`,f=a.textarea`
  ...
  `}
`;export{s as T,f as a,n as b,p as c,o as g};
