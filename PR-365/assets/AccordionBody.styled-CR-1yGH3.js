import{n as a}from"./emotion-styled.browser.esm-DpDeK1WQ.js";const t={White:"white",Grey:"grey"},i=o=>({white:o.palette.surface.contrast,grey:o.palette.surface.default}),s=o=>({white:o.palette.primary.light,grey:o.palette.surface.medium}),e=o=>({white:`0px 1px 0px 0px ${o.palette.border.light}`,grey:"none"}),p=a.div`
