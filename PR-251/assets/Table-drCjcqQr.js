...
`,W=({children:e,style:o,dataTestId:s})=>f.jsx(j,{"data-testid":s??"table-body",style:o,children:e}),D=(e,o,s,r)=>{const n=new IntersectionObserver(([{isIntersecting:t}])=>{r((o>0||s>0)&&!t)},{threshold:1});return e.current&&n.observe(e.current),n},k=(e,o)=>l.Children.map(e,(s,r)=>l.isValidElement(s)?o(s,r):s),A=e=>[...e.children].map(s=>s.clientWidth),U=(e,o)=>o.slice(0,e).reduce((n,t)=>n+t,0),M=(e,o)=>o.slice(e+1).reduce((n,t)=>n+t,0),V=m.tr`
  ...
  `}
`,z=0,X=1,Z=({children:e,dataTestId:o,style:s,onClick:r})=>{const n=!!r,{columnsLength:t,setFixedColumns:d,setFixedEndColumns:a,fixedColumnCount:u,fixedEndColumnCount:c,isColumnsFixed:b,setShowBoxShadow:h}=g(),x=l.useRef(null);let i=e;if(b&&x.current){const y=[],E=[],C=[],T=A(x.current);i=k(e,(w,p)=>{let S=0;const R=p<u,F=p>=t-c;return R&&(S=U(p,T),y.push(p),C[z]=p),F&&(S=M(p,T),E.unshift(p),C[X]=C[1]??p),R||F?l.cloneElement(w,{...w.props,"data-column-index":p,"data-fixed-position":S}):w}),d(y),a(E),h(C)}return f.jsx(V,{ref:x,...r&&{onClick:r},"data-testid":o??"table-row",selectableRow:n,style:s,children:i})},G=110,K=m.td`
