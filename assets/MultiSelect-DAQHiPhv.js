import{j as l}from"./jsx-runtime-CKrituN3.js";import{B as w}from"./index-gq_RjDZX.js";import{C as D}from"./Close-CGHfkSk3.js";import{r as o}from"./index-CBqU2yxZ.js";import{n as f}from"./emotion-styled.browser.esm-DhD7UCCJ.js";import{T as E}from"./Tag-D-KFSfjp.js";import{T as j}from"./Typography-AgncjmvB.js";import{O as C,a as R,D as k}from"./DropdownMenu-bC2eOzsR.js";import{u as A}from"./emotion-element-43c6fea0.browser.esm-CsO0Y6lU.js";import"./index-DWb54gmw.js";import"./index-BtM5VmRH.js";import{u as I}from"./useClickOutside-D7JrBqcS.js";var d=(e=>(e.ADD="ADD",e.REMOVE="REMOVE",e))(d||{});const T=(e,t)=>{const{type:r}=t;switch(r){case d.ADD:return e.find(s=>s.value===t.payload.value)?e.map(s=>s.value===t.payload.value?t.payload:s):[...e,t.payload];case d.REMOVE:return e.filter(s=>s.value!==t.payload.value);default:return e}},O={state:[],isOpen:!1,dispatch:()=>null,setIsOpen:()=>null},$=o.createContext(O),B=({children:e,defaultValue:t,name:r})=>{const[a,s]=o.useReducer(T,O.state),[p,i]=o.useState(O.isOpen);return o.useEffect(()=>t&&t.forEach(c=>s({type:d.ADD,payload:c})),[t]),l.jsx($.Provider,{value:{state:a,dispatch:s,isOpen:p,setIsOpen:i,name:r},children:e})},M=()=>{const e=o.useContext($);if(!e)throw new Error("MultiSelect compound components cannot be rendered outside the MultiSelect component");return e},V=f.li`
  ${({theme:e,disabled:t})=>`
