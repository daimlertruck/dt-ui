import{s as l}from"./emotion-styled.browser.esm-DuL_gwYN.js";const d=(t,e)=>({default:e.palette.surface.default,contrast:e.palette.surface.contrast,light:e.palette.surface.light})[t]||e.palette.surface.default,c=l.div`
...
`,b=l.div`
  ...
  `}
`,g=l.div`
  ${({theme:t,isFloatingLabel:e,variant:o,backgroundFill:n,hasError:a})=>{const r=a?t.palette.error.default:t.palette.border.medium,i=a?t.palette.error.default:t.palette.border.dark;return`
    display:flex;
    flex-direction: row;
    align-items: center;
    min-width: 198px;
