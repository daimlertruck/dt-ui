...
`,M=n.button`
  ...
  `}
`,C={[o.Error]:f,[o.Info]:h,[o.Success]:m,[o.Warning]:w,[o.Default]:null},a=({children:t,dataTestId:e,type:r,isDismissable:c=!0})=>{const[d,g]=u.useState(!1),i=C[r],p=()=>{g(!0)};return d?null:s.jsxs($,{"data-testid":e??"message",type:r,children:[i?s.jsx(y,{type:r,children:s.jsx(i,{"data-testid":"message-icon",height:"16px",width:"16px"})}):null,s.jsx(j,{children:t}),c?s.jsx(M,{onClick:p,children:s.jsx(x,{height:"16px",width:"16px"})}):null]})};a.Title=({children:t})=>s.jsx(l,{color:"content.heading",element:"h2",fontStyles:"body2Bold",children:t});a.Description=({children:t})=>s.jsx(l,{color:"content.body",fontStyles:"body3",children:t});a.Action=({children:t,dataTestId:e})=>s.jsx(b,{"data-testid":e??"message-action",children:t});export{a as M,o as O};
