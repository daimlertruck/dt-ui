import{j as t}from"./jsx-runtime-CKrituN3.js";import{h as p,a as x}from"./Backdrop-T-GZZgir.js";import"./index-BUn_IA5M.js";import{P as f}from"./Portal-U_0UEmB3.js";import{r as c}from"./index-CBqU2yxZ.js";import{u as m}from"./useClickOutside-D7JrBqcS.js";import{n as s}from"./emotion-styled.browser.esm-DhD7UCCJ.js";import{B as u}from"./index-gq_RjDZX.js";import{I as y}from"./Icon-CHFlL13I.js";import{T as l}from"./Typography-Bej0cKKK.js";import{S as b}from"./Spinner-BxoLAn1a.js";import"./index-BtM5VmRH.js";import{M as $}from"./z-index-C-tE6wDk.js";const g=s.div`
  ${({theme:o})=>`
...
`,v=({dataTestId:o,handleClose:n,hasBackgroundColor:e=!1,hasBorder:a=!1,title:r,subTitle:d})=>t.jsxs(k,{"data-testid":o??"modal-header",hasBackgroundColor:e,hasBorder:a,children:[t.jsxs(u,{style:{justifyContent:"space-between",flexDirection:"row"},children:[t.jsx(l,{color:"content.heading",element:"h4",fontStyles:"h4",children:r}),t.jsx(y,{code:"close",dataTestId:"close-icon",onClick:n,size:"large"})]}),d?t.jsx(l,{color:"content.body",element:"h5",fontStyles:"body1",children:d}):null]}),M=s.div`
  ...
  `}
`,S=()=>t.jsx(M,{children:t.jsx(b,{size:"extra-large"})}),C=s.div`
  position: fixed;
  z-index: ${$};
  left: 50%;
  top: 50%;
