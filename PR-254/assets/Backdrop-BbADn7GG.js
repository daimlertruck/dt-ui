import{j as s}from"./jsx-runtime-CKrituN3.js";import{r as n}from"./index-CBqU2yxZ.js";import"./index-Bbtf3kiN.js";import"./index-BtM5VmRH.js";import{B as p}from"./z-index-Ds5QkyqS.js";import{n as c}from"./emotion-styled.browser.esm-DhD7UCCJ.js";const d=(t,r=1)=>{const[a,e,o]=(t.match(/\w\w/g)||[]).map(i=>parseInt(i,16));return`rgba(${a},${e},${o},${r})`},m={dark:.85,light:.2},l=c.div`
  ${({theme:t,type:r})=>`
      width: 100vw;
      height: 100vh;
      position: fixed;
