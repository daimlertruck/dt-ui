import{j as o}from"./jsx-runtime-CKrituN3.js";import{n as g}from"./emotion-styled.browser.esm-DhD7UCCJ.js";import{r as a}from"./index-CBqU2yxZ.js";import{I as h}from"./Icon-Y_fTWZv7.js";import{T as b}from"./Typography-Dz-bqQ4l.js";import"./index-Bbtf3kiN.js";import"./index-BtM5VmRH.js";import{a as C}from"./z-index-Ds5QkyqS.js";import{u as k}from"./emotion-element-43c6fea0.browser.esm-CsO0Y6lU.js";import{u as E}from"./useClickOutside-D7JrBqcS.js";const I=g.div`
  display: flex;
  align-items: center;
  padding-left: 15px;
  margin-top: 4px;
...
`,j=({children:t,dataTestId:e,style:n})=>o.jsx(P,{"data-testid":`${e?e+"-":""}menu`,style:n,children:t}),R=g.button`
  ${({theme:t,style:e,hasBorder:n=!0,hasError:r=!1})=>`
    ...
    ${e}
  `}
`,U=({children:t,label:e,style:n,dataTestId:r="dropdown-select",isDisabled:s=!1,hasBorder:c=!0,hasError:u=!1})=>{const{state:p,setState:d,isOpen:x,setIsOpen:$}=S(),w=k(),m=l=>{l.preventDefault(),$(i=>!i)},f=a.Children.count(t);a.useEffect(()=>{a.Children.toArray(t).find(i=>i.props.option.value===p.value)||d({text:"",value:""})},[t,d,p.value]),a.useEffect(()=>{if(f===1){const l=a.Children.map(t,i=>i&&i.props.option);if(l&&l[0]){const i={text:l[0].text??l[0].value,value:l[0].value};d(i)}}},[f,d,t]);const D=s||f<2;return o.jsxs(o.Fragment,{children:[o.jsxs(R,{"data-testid":r,disabled:D,hasBorder:c,hasError:u,onClick:m,style:n,children:[o.jsxs("div",{style:{overflow:"hidden"},children:[o.jsx(b,{color:D?"content.light":"content.default",fontStyles:"pXXSmall",children:e}),o.jsx(b,{color:D?"content.light":"content.default",fontStyles:"pSmall",style:{textOverflow:"ellipsis",overflow:"hidden"},children:p.value?p.text:"Select an option"})]}),o.jsx(h,{code:x?"expand_less":"expand_more",color:!x&&s?w.palette.content.light:"currentColor",size:"medium"})]}),x?o.jsx(j,{dataTestId:r,children:t}):null]})},X=({children:t,style:e,dataTestId:n})=>{const{setIsOpen:r}=S(),s=a.useRef(null);return E({ref:s,handler:()=>r(!1)}),o.jsx("div",{"data-testid":n,ref:s,style:e,children:t})},z=g.div`
  ${({theme:t,style:e})=>`
    ...
    ${e}
  `}
`,v=({children:t,defaultValue:e,style:n,name:r,dataTestId:s="dropdown"})=>o.jsx(M,{defaultValue:e,name:r,children:o.jsx(z,{"data-testid":s,role:"menu",style:n,children:t})});v.Container=X;v.Detail=_;v.Select=U;v.Option=N;v.Menu=j;export{v as D,j as a};
