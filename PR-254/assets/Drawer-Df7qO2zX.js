import{j as n}from"./jsx-runtime-CKrituN3.js";import{c as f,G as w}from"./index-Bbtf3kiN.js";import{r as i}from"./index-CBqU2yxZ.js";import{T as g}from"./Typography-Dz-bqQ4l.js";import{I as $}from"./IconButton-CUf0TBY3.js";import{C as y}from"./Close-CGHfkSk3.js";import{n as d}from"./emotion-styled.browser.esm-DhD7UCCJ.js";import"./index-BtM5VmRH.js";import{D as h}from"./z-index-Ds5QkyqS.js";import{u as b}from"./emotion-element-43c6fea0.browser.esm-CsO0Y6lU.js";const v=({title:e})=>n.jsx(g,{color:"content.dark",element:"h4",fontStyles:"h4",children:e}),D={handleClose:()=>null},m=i.createContext(D),S=({handleClose:e,children:s})=>n.jsx(m.Provider,{value:{handleClose:e},children:s}),j=()=>{const e=i.useContext(m);if(!e)throw new Error("Drawer compound components cannot be rendered outside the Drawer component");return e},C=d.header`
  ${({theme:e})=>`
    display: flex;
...
`,R=d.div`
  ...
  `}
`,O=e=>parseFloat(e.replace(/[^\d.]/g,""))*1e3,p=({isVisible:e,setIsVisible:s,children:l,dataTestId:o})=>{const[c,r]=i.useState(!1),t=b(),a=i.useCallback(()=>{r(!1),setTimeout(()=>{s(!1)},O(t.animations.emphasizedDecelerate.timingFunction))},[s,t.animations.emphasizedDecelerate.timingFunction]);return i.useEffect(()=>{const u=x=>{x.key==="Escape"&&a()};return r(e),document.addEventListener("keydown",u),()=>{document.removeEventListener("keydown",u)}},[a,e]),n.jsx(S,{handleClose:a,children:n.jsxs(F,{children:[e?n.jsx(w,{styles:I}):null,n.jsx(L,{"data-testid":"drawer-overlay",isVisible:c,onClick:a}),n.jsx(R,{"data-testid":o??"drawer-content-container",isVisible:c,children:l})]})})};p.Title=v;p.Header=E;p.Body=z;export{p as D};
