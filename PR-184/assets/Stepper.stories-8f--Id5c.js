import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{S as a,a as t}from"./Step-TX1mgo7v.js";import"./index-4g5l5LRQ.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./emotion-styled.browser.esm-QTPHyGVR.js";import"./extends-E30VzY7q.js";import"./emotion-element-c39617d8.browser.esm-4Kx8mvQ5.js";import"./Counter-LGyezUq9.js";import"./Typography-D6FO4u36.js";import"./MultiSelectProvider-vrdgqO57.js";const D={title:"Data Display/Stepper",component:a},u=({currentStep:c,orientation:S,options:r,completed:d})=>e.jsxs(a,{orientation:S,children:[r.map((o,i)=>e.jsxs(t,{isActive:c===i+1,isCompleted:d.includes(i+1),children:[e.jsx(t.Counter,{children:i+1}),e.jsx(t.Label,{children:o})]},o)),e.jsxs(t,{isDisabled:!0,children:[e.jsx(t.Counter,{children:r.length+1}),e.jsx(t.Label,{children:"Disabled"})]},r.length),e.jsxs(t,{isError:!0,children:[e.jsx(t.Counter,{children:r.length+2}),e.jsx(t.Label,{children:"Error"})]},r.length+1),e.jsxs(t,{isActive:!0,isError:!0,children:[e.jsx(t.Counter,{children:r.length+3}),e.jsx(t.Label,{children:"Active Error"})]},r.length+2)]}),n=u.bind({});n.args={currentStep:1,completed:[],orientation:"vertical",options:["API version definition","Specifications","Review"]};var p,s,l;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`({
  currentStep,
  orientation,
  options,
  completed
  ...
  </Stepper>`,...(l=(s=n.parameters)==null?void 0:s.docs)==null?void 0:l.source}}};const f=["Default"];export{n as Default,f as __namedExportsOrder,D as default};
